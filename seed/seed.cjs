...
// ─── ACCOUNTS ────────────────────────────────────────────────────────────────
const ACCOUNTS = [
  { institution: 'Amex', displayName: 'Amex Checking', type: 'Debit', category: 'Checking', balance: 214.67 },
  { institution: 'Amex', displayName: 'Amex Credit', type: 'Credit', category: 'Credit', balance: 4686.09 },
  { institution: 'SoFi', displayName: 'SoFi Checking', type: 'Debit', category: 'Checking', balance: 7030.27 },
  { institution: 'SoFi', displayName: 'SoFi HYSA', type: 'Debit', category: 'Savings', balance: 631.45 },
  { institution: 'Amex', displayName: 'Amex HYSA', type: 'Debit', category: 'Savings', balance: 6526.98 },
  { institution: 'Navy Fed', displayName: 'Navy Fed 4SN', type: 'Debit', category: 'Checking', balance: 2956.22 },
  { institution: 'Navy Fed', displayName: 'Navy Fed EF', type: 'Debit', category: 'Savings', balance: 1592.92 },
  { institution: 'Navy Fed', displayName: 'Navy Fed Roth IRA', type: 'Debit', category: 'Investments', balance: 4264.24 },
  { institution: 'Navy Fed', displayName: 'Wife Credit', type: 'Credit', category: 'Credit', balance: 792.84 },
  { institution: 'Citi', displayName: 'Citi Credit', type: 'Credit', category: 'Credit', balance: 454.25 },
  { institution: 'Clasp', displayName: 'Student Loan', type: 'Credit', category: 'Loan', balance: 6460.00 },
  { institution: 'Patient Fi', displayName: 'Laser Big', type: 'Credit', category: 'Loan', balance: 8327.18 },
  { institution: 'Alphaeon', displayName: 'Laser Small', type: 'Credit', category: 'Credit', balance: 1403.00 },
  { institution: 'Best Buy', displayName: 'Best Buy Credit', type: 'Credit', category: 'Credit', balance: 2404.70 },
  { institution: 'Fidelity', displayName: 'Fidelity Investments', type: 'Debit', category: 'Investments', balance: 0 },
  { institution: 'Vanguard', displayName: '401K', type: 'Debit', category: 'Investments', balance: 1921.06 },
  { institution: 'TSP', displayName: 'TSP', type: 'Debit', category: 'Investments', balance: 0 },
  { institution: 'Toyota Financial', displayName: 'Corolla Hatchback', type: 'Credit', category: 'Loan', balance: 34029.15 },
  { institution: 'T-Mobile', displayName: "Wife's iPhone", type: 'Credit', category: 'Credit', balance: -84.58, notes: 'Total: 1,015' },
